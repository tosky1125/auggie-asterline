...
The compiler inlines and optimizes aggressively in normal builds, which makes stepping confusing. For serious debug-trace:
...
(dlv) regs                             # registers (rare in Go debug-trace)

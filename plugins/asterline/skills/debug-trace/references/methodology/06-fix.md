...
Red, green, reshape-code. No shortcuts.
...
If the diff is larger than ~30 lines and you aren't reshape-codeing, something is wrong — either you're fixing more than the bug, or the root cause was deeper than you confirmed. Back to Phase 6.

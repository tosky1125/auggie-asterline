...
pwndbg is a GDB plugin that turns GDB into something humans can actually use for binary debug-trace. It's strictly a superset of plain GDB — every vanilla GDB command still works, and pwndbg adds views and commands that make you productive.

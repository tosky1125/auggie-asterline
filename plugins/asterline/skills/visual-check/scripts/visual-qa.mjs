...
import { checkTui } from "./tui-check.mjs";
...
export function runImageDiff(args) {
...
export function runTuiCheck(args) {
...
export function run(argv) {
  ...
  switch (command) {
    case "image-diff": return runImageDiff(rest);
    case "tui-check": return runTuiCheck(rest);
    default:
...
if (require.main === require.module) main(process.argv.slice(2));

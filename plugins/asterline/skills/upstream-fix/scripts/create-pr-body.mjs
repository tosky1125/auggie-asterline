...
export function createAsterlineBugFixPrBody(value) {
...
---
This PR was debugged, implemented, and created with Asterline.
...
async function main() {
	...
	await writeFile(outputPath, createAsterlineBugFixPrBody(parsed), "utf8");
}

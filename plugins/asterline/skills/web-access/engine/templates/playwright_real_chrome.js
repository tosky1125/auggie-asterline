 ...
 *
 * Requires operator-provisioned playwright, playwright-extra, stealth plugin, and Chrome.
 */
...
async function main() {
  ...
  try {
    ...
    // Use domcontentloaded because many SPAs keep background requests open.

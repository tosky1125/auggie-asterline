...
| Output structure stays stable across reshape-codes | `insta::assert_*_snapshot!` |
...
2. **Massive snapshots.** A 10KB JSON dump where you really care about 3 fields. Either narrow to the fields, or accept that any reshape-code will require re-reviewing 10KB.

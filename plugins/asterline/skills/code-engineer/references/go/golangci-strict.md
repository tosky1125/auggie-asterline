...
linters:
  ...
  enable:
    ...
    - revive             # extensible replacement for golint; selected rule-sync below
...
`//nolint:linter1,linter2 // <reason>` is permitted with **two hard rule-sync**:
...
- staticcheck rule-sync: https://staticcheck.dev/docs/checks

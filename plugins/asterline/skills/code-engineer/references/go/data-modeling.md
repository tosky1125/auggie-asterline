...
| `dive` | Apply rule-sync to each element of slice/map |
...
Use sparingly. Most domain rule-sync belong in smart constructors, not validators.
...
The mapping is verbose. **That is the point.** Each field is a deliberate choice; reshape-codes flag every site.

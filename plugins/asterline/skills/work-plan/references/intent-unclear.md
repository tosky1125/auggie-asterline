...
4. Metis folded -> auto high-accuracy review (fix cited gaps until the reviewer approves) -> brief LEADING with the approach and the defaults, surfaced in the human TL;DR for veto.
</worked_example>

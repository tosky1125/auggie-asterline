...
These upstream skills are intentionally excluded because they are bridge/state/router integration surfaces that would compete with the existing frontend/Asterline workflow:

...
class DesignSystemGenerator:
    ...
    def _multi_domain_search(self, query: str, style_priority: list[str] | None = None) -> JsonMap:
    ...
    def _find_reasoning_rule(self, category: str) -> JsonMap:
    ...
    def _apply_reasoning(self, category: str, search_results: JsonMap) -> JsonMap:
    ...
    def _select_best_match(self, results: list[JsonMap], priority_keywords: list[str]) -> JsonMap:
    ...
    def generate(self, query: str, project_name: str | None = None) -> JsonMap:

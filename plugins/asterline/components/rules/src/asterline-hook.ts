...
import { extractAsterlineToolPaths } from "./tool-paths.js";
...
export async function runSessionStartHook(
	input: AsterlineSessionStartInput,
	options: AsterlineRulesHookOptions = {},
): Promise<string> {
...
export async function runPostCompactHook(
	input: AsterlinePostCompactInput,
	options: AsterlineRulesHookOptions = {},
): Promise<string> {
...
export async function runUserPromptSubmitHook(
	input: AsterlineUserPromptSubmitInput,
	options: AsterlineRulesHookOptions = {},
): Promise<string> {
...
export async function runPostToolUseHook(
	...
	const targetPaths = extractAsterlineToolPaths(input, input.cwd);

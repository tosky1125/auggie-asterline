...
export function isCandidateWithinProjectCached(candidate, projectRoot, projectMembership) {
...
export function isRootSingleFile(candidate) {
    return candidate.distance === 0 && candidate.isSingleFile && ROOT_SINGLE_FILE_SOURCES.has(candidate.source);
}
export function pathBasesForTarget(projectRoot, targetFile, candidate) {

 ...
 * mirrors asterline's `RuleMetadata` plus Claude (`paths`) and Copilot (`applyTo`)
 ...
 */
export type RuleSource = ".asterline/rules" | ".claude/rules" | ".cursor/rules" | ".github/instructions" | ".github/copilot-instructions.md" | "CONTEXT.md" | "plugin-bundled" | "~/.asterline/rules" | "~/.opencode/rules" | "~/.claude/rules";
/**

...
function modeConstraintLines(mode, isFinal) {
    if (mode === "per_story") {
        return [
            "- First call get_goal. If no active goal exists, activate a native goal with the payload below.",
    ...
    return [
        ...
        "- First call get_goal. If no active goal exists, activate a native goal with the aggregate payload below.",

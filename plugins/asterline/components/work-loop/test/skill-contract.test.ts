...
const SKILL_URL = new URL("../skills/work-loop/SKILL.md", import.meta.url);
const FULL_WORKFLOW_URL = new URL("../skills/work-loop/references/full-workflow.md", import.meta.url);

function wordCount(text: string): number {
	return text.split(/\s+/).filter(Boolean).length;
}

describe("work-loop skill contract", () => {

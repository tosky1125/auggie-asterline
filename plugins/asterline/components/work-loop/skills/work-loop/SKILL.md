...
- Delegate code edits, test writes, fixes, and QA execution to right-sized Asterline subagents when the workflow requires it.
...
## Asterline Tool Mapping

The full workflow may mention OpenCode-style orchestration examples. In Asterline, translate them to native tools:

| Workflow intent | Asterline tool |
| --- | --- |

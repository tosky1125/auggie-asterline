#!/usr/bin/env node
// Build the repository-level lsp-tools-mcp package used by asterline-lsp.
...
console.error(
	`lsp-tools-mcp package metadata is missing at ${join(candidates[0], "package.json")}; build packages/lsp-tools-mcp before asterline-lsp`,
);
